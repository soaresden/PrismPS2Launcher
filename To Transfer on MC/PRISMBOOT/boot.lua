...
Todo queda en mc0:/PRISMBOOT/BOOT_LOG.txt, linea a linea.
-------------------------------------------------------------------------------------]]
...
local LOG = "PRISMBOOT (mc0) - journal\n=========================\n\n"
...
if cible == nil then
	...
	error("PRISMBOOT: disco interno no encontrado (mc0:/PRISMBOOT/BOOT_LOG.txt)")
end
