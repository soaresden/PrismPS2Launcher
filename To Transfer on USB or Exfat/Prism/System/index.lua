...
Regla de eleccion de la instalacion que gobierna (PREFERIR_DISCO_INTERNO=true):
  1. el DISCO INTERNO, reconocido por su marcador
     "Roms/!Prism/internal-ata-disk.flag" - nunca por nombre de unidad.
  ...
  3. cualquier "massN:/Prism" completo, como ultimo recurso.

Todo queda en "Prism.log" junto al ELF, con la categoria PRE delante.
-------------------------------------------------------------------------------------]]
...
if cible == nil then
	...
	log("Roms/!Prism/; o hay un Prism completo en un USB.")
	error("Prism: instalacion no encontrada (ver Prism.log)")
end
